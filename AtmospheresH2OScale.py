...
class AtmospheresH2OScale(object):
    ''' 
    '''

    def __init__(self, ref_prec, ref_numtran, targ_name, targ_numtran, targ_prec, targ_Rs, targ_Rp, targ_T, targ_g, species_dict, species, numH, bin_size, wave_range, model_T, model_g, smooth_model):
    ...
    def make_model_depths(self):
        ...
        for s in self.species:
            ...
            model_depths = np.array(self.model_dict[self.species[0]]['depths'])
            ...
            model_depths_binned = np.array(self.model_dict[self.species[0]]['avg_depths'])
