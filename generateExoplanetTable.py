...
def generateTransitingExoTable(sy_dist_upper=25, st_rad_upper=0.59, st_mass_upper=0.58, pl_rade_upper=1.85, pl_per_upper=30, outputpath="."):
    ...
    * default upper limits on stellar mass and radius are M dwarf upper limits
    ...
    result = service.search(f"SELECT hostname,pl_name,sy_dist,rastr,decstr,sy_vmag,sy_jmag,sy_kmag,st_mass,st_rad,st_raderr1,st_raderr2,st_teff,st_tefferr1,st_tefferr2,st_logg,st_lum,pl_tranmid,pl_tranmiderr1,pl_tranmiderr2,pl_rade,pl_radeerr1,pl_radeerr2,pl_bmasse,pl_bmasseerr1,pl_bmasseerr2,pl_orbper,pl_orbpererr1,pl_orbpererr2,pl_orbsmax,pl_orbsmaxerr1,pl_orbsmaxerr2,pl_orbincl,pl_imppar,pl_orbeccen,pl_orbeccenerr1,pl_orbeccenerr2,pl_ratror,pl_ratrorerr1,pl_ratrorerr2,pl_ratdor,pl_ratdorerr1,pl_ratdorerr2,tran_flag,rv_flag FROM pscomppars WHERE pl_rade<={pl_rade_upper} and sy_dist<={sy_dist_upper} and st_rad<={st_rad_upper} and st_mass<={st_mass_upper} and pl_orbper<={pl_per_upper} and tran_flag=1 ORDER BY pl_name")
...
def generateExoTable(sy_dist_upper=25, st_rad_upper=0.59, st_mass_upper=0.58, pl_per_upper=30, outputpath="."):
    ...
    * default upper limits on stellar mass and radius are M dwarf upper limits
    ...
    access_url = "https://exoplanetarchive.ipac.caltech.edu/TAP"
    service = vo.dal.TAPService(access_url)
    result = service.search(f"SELECT hostname,pl_name,sy_dist,rastr,decstr,sy_vmag,sy_jmag,sy_kmag,st_mass,st_rad,st_raderr1,st_raderr2,st_teff,st_tefferr1,st_tefferr2,st_logg,st_lum,pl_tranmid,pl_tranmiderr1,pl_tranmiderr2,pl_rade,pl_radeerr1,pl_radeerr2,pl_bmasse,pl_bmasseerr1,pl_bmasseerr2,pl_orbper,pl_orbpererr1,pl_orbpererr2,pl_orbsmax,pl_orbsmaxerr1,pl_orbsmaxerr2,pl_orbincl,pl_imppar,pl_orbeccen,pl_orbeccenerr1,pl_orbeccenerr2,pl_ratror,pl_ratrorerr1,pl_ratrorerr2,pl_ratdor,pl_ratdorerr1,pl_ratdorerr2,tran_flag,rv_flag FROM pscomppars WHERE sy_dist<={sy_dist_upper} and st_rad<={st_rad_upper} and st_mass<={st_mass_upper} and pl_orbper<={pl_per_upper} ORDER BY pl_name")
...
def generateExoSystem(hostname, outputpath="."):
    ...
    * default upper limits on stellar mass and radius are M dwarf upper limits
    ...
    access_url = "https://exoplanetarchive.ipac.caltech.edu/TAP"
    service = vo.dal.TAPService(access_url)
    result = service.search(f"SELECT hostname,pl_name,sy_dist,sy_disterr1,sy_disterr2,rastr,decstr,sy_vmag,sy_jmag,sy_kmag,st_mass,st_masserr1,st_masserr2,st_rad,st_raderr1,st_raderr2,st_teff,st_tefferr1,st_tefferr2,st_tefferr1,st_tefferr2,st_logg,st_lum,pl_tranmid,pl_tranmiderr1,pl_tranmiderr2,pl_rade,pl_radeerr1,pl_radeerr2,pl_bmasse,pl_bmasseerr1,pl_bmasseerr2,pl_orbper,pl_orbpererr1,pl_orbpererr2,pl_orbsmax,pl_orbsmaxerr1,pl_orbsmaxerr2,pl_orbincl,pl_imppar,pl_orbeccen,pl_orbeccenerr1,pl_orbeccenerr2,pl_eqt,pl_ratror,pl_ratrorerr1,pl_ratrorerr2,pl_ratdor,pl_ratdorerr1,pl_ratdorerr2,tran_flag,rv_flag FROM pscomppars WHERE hostname='{hostname}' ORDER BY pl_name")
